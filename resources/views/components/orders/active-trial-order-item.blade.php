@props(['order'])
<div
    class="mb-3 bg-dark-100 rounded-xl border border-yellow-500 p-4 text-white border-r-8 border-r-yellow-500 flex justify-between items-center">
    <div class="flex items-center">
        <div class="mr-3">
            <img src="{{ asset('assets/rust-logo.png') }}" width="45" class="rounded-full">
        </div>
        <div>
            <p class="text-sm mb-1"><strong class="text-rust">Trial OrderID#</strong> - {{ $order->id }}
            </p>
