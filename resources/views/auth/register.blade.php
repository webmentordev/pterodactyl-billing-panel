<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            <x-input-label for="answer" class="text-gray-100" :value="__('What is the answer?')" />
            <x-text-input id="answer" class="block w-full mt-1" type="text" name="result" required
                placeholder="What is {{ $start }} + {{ $end }}" />
