...
This email is to inform you that your server has been suspended but not deleted. You have a 2-day grace period to renew your server. If the renewal is not completed within this timeframe, the server and all its associated data—including configurations, databases, and files stored via FTP—will be permanently deleted.
