<div class="flex items-center justify-center py-12 mt-12" id="packages" x-data="{ show: false }">
    <div class="max-w-5xl w-full p-3 text-white">
        ...
        <p class="text-center">Last updated: 26 Octuber, 2025</p>
        <div class="mt-4 p-8 rounded-lg bg-dark-100 border border-white/10 policy 510px:p-3">
            ...
            <h3>2. Can you request the refund?</h3>
            <p>Our payment processor, Tebex, does not allow refunds on transactions, so we are unable to refund
                payments. However, for your satisfaction, you have the option to try out our <a
                    href="{{ route('free.trial') }}" class="underline text-rust font-semibold">Free Server
                    Trials</a>, which have the same
                specifications as paid servers. Trial servers are hosted on the same machines as paid servers, so the
                performance is the same.</p>
            ...
            <h3>3. Changes to this Refund Policy</h3>
            ...
            <h3>4. Free Trial Server Refunds</h3>
