    ...
    <div class="max-w-5xl w-full p-3 text-white">
        ...
        <div class="mt-4 p-8 rounded-lg bg-dark-100 border border-white/10 policy">
            ...
            <ul>
                ...
                <li>Please provide the reason for the refund so we can understand the cause and improve our services.
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>When approved, refunds will be issued to the original payment method within 7-10 business days.</li>
                <li>Partial refunds of {{ config('app.refund_percentage') }}% will be issued.</li>
            </ul>
