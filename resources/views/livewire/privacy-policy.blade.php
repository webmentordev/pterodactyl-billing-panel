    ...
    <div class="max-w-5xl w-full p-3 text-white">
        <div class="w-full flex items-center justify-center">
            <h1 class="mb-4 m-auto text-center">
                <strong title="RustDedicated Hosting Privacy Policy" class="text-5xl text-center"
        ...
        <div class="mt-4 p-8 rounded-lg bg-dark-100 border border-white/10 policy 510px:p-3">
            ...
            <p>RustDedicated Hosting ("we," "us," "our") is committed to protecting your privacy. This Privacy Policy
                ...
                Services, including signup, login, billing, and the Game Panel.</p>
            ...
            <ul>
                ...
                <li>To trusted payment processors to facilitate billing transactions.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Contact us regarding any privacy concerns or questions.</li>
            </ul>
